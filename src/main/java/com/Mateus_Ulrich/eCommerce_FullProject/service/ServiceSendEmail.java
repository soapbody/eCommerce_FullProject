...
public class ServiceSendEmail {
    private String userName = "mateusulrich98@gmail.com";
    private String senha = "aehantaknyploard";
    @Async
    public void enviarEmailHtml(String assunto, String mensagem, String emailDestino) throws MessagingException, UnsupportedEncodingException {
       ...
       // properties.put("mail.smtp.socketFactory.class", "javax.net.ssl.SSLSocketFactory");
        ...
        message.setFrom(new InternetAddress(userName, "Mateus Ulrich - JAVA", "UTF-8"));
